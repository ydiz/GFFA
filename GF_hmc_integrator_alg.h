...
template <class FieldImplementation,
          class RepresentationPolicy =
              Representations<FundamentalRepresentation> >
class GFLeapFrog : public GFIntegrator<FieldImplementation,
                                   RepresentationPolicy> {
 public:
  typedef GFLeapFrog<FieldImplementation, RepresentationPolicy>
      Algorithm;
  ...
  GFLeapFrog(GridBase* grid, IntegratorParameters Par,
           MyActionSet<Field, RepresentationPolicy>& Aset, const Coordinate &cell_size)
      : GFIntegrator<FieldImplementation, RepresentationPolicy>(
            grid, Par, Aset, cell_size){};
