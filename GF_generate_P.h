...
// Cannot use parallel_for 
  ...
  Pk = Pk * 0.5; // Must multiply it by 0.5 

  Pk = Pk * sqrt(HMC_MOMENTUM_DENOMINATOR);   // IMPORTANT: after Grid changed its convention since Dec 19 2018, must multiply the initial momentum by sqrt(2).   See generate_momenta function in Grid/qcd/action/gauge/GaugeImplTypes.h
